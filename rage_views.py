  ...
  if not error:
    ...
    for line in lines:
      ...
      if msg.endswith(':)'):
        ...
        faces = ['beh','dude-come-on','epicwin','french','grin','happy','hehehe','herp','horror','loool','monocole','pfftch','rage','redeyes','smile','suspicious','unhappy','wait','concentrated','kittehsmile']
